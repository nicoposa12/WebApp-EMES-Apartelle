        ...
        <div class="row g-0">
          ...
          <div class="col-lg-5 d-none d-lg-flex bg-gold-gradient p-5 flex-column justify-content-between text-white">
            ...
            <div class="branding-content">
              <h2 class="serif-font display-5 fw-bold mb-3">Recover Access</h2>
              <p class="lead opacity-80 small">Enter your email address and we'll send you a secure link to reset your password and regain access to your account.</p>
            </div>
          ...
          <div class="col-lg-7 p-4 p-md-5 bg-white-glass">
            <div class="form-header mb-5">
              ...
              <p class="text-muted small">We'll send a password recovery link to your inbox.</p>
            </div>
            ...
            <form @submit.prevent="handleSubmit">
              <div class="mb-4 custom-input-group">
                ...
                <div class="input-modern-wrapper">
                  ...
                  <input v-model="email" type="email" class="form-control-modern ps-5" placeholder="your-email@gmail.com" required :disabled="loading">
                </div>
              </div>
              ...
              >
                ...
                <span class="fw-bold text-uppercase tracking-wider">{{ loading ? 'Sending...' : 'Send Reset Link' }}</span>
              </button>

              <p class="text-center text-muted small mb-0">
                Remembered your password? 
                <router-link to="/login" class="text-gold fw-bold text-decoration-none hover-underline">Back to Login</router-link>
              </p>
            </form>
          </div>
        </div>
...
<style scoped>
/* Reuse the same premium styles from LoginView */
.auth-page { min-height: 100vh; position: relative; overflow: hidden; background: #0f172a; }
.auth-bg-overlay { position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: radial-gradient(circle at top right, rgba(188, 145, 81, 0.2), transparent 40%), url('https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=2000') center/cover; filter: brightness(0.5); z-index: 1; }
